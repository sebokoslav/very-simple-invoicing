        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetAndHouseNo = table.Column<string>(type: "TEXT", nullable: false),
                    PostalCode = table.Column<string>(type: "TEXT", nullable: false),
                    City = table.Column<string>(type: "TEXT", nullable: false),
                    Country = table.Column<string>(type: "TEXT", nullable: false),
                    BusinessId = table.Column<string>(type: "TEXT", nullable: false),
                    TaxId = table.Column<string>(type: "TEXT", nullable: false),
                    VATRegNo = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxId = table.Column<string>(type: "TEXT", nullable: false),
                    VATRegNo = table.Column<string>(type: "TEXT", nullable: false),
                    SignedIn = table.Column<string>(type: "TEXT", nullable: false),
                    StampImagePath = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveredOn = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "BankTransfer" });
